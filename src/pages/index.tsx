...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>Pruned Service Provider</title>
        <meta name="description" content="Pruned Service Provider Site" />
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-44">
              <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div
                  ...
                  Frictionless services for professionals. <a href="#"
              ...
              <div className="text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Order industry-standard services now.
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Order your service now, pay after your service is complete.
                </p>
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  ...
                  <a href="#" className="text-base font-semibold leading-7 text-gray-900">Learn more <span
